...
if [[ "$1" == "overwrite" ]]; then
	...
	# echo "hamplot infid${joined_uncorr} infid ${joined_timestamps%?} 7,16 1,1 10" >> input/temp.txt
	...
	echo "sbload ${timestamps[0]}" > input/temp.txt
	echo "hamplot infid,uncorr infid ${timestamps[1]} 7,8 1,1 10" >> input/temp.txt
