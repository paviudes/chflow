...
/* BEGIN: Cython Metadata
{
    ...
    "module_name": "src.simulate.constants"
}
END: Cython Metadata */
...
#define __PYX_HAVE__src__simulate__constants
#define __PYX_HAVE_API__src__simulate__constants
#ifdef _OPENMP
#include <omp.h>
#endif /* _OPENMP */
...
#define __Pyx_MODULE_NAME "src.simulate.constants"
int __pyx_module_is_main_src__simulate__constants = 0;

/* Implementation of 'src.simulate.constants' */
...
static int __pyx_f_3src_8simulate_9constants_InitConstants(__pyx_t_3src_8simulate_9constants_constants_t *__pyx_v_consts) {
  int __pyx_v_p;
  int __pyx_v_r;
  int __pyx_v_c;
  int __pyx_r;
  ...
  __Pyx_RefNannySetupContext("InitConstants", 0);

  /* "src/simulate/constants.pyx":12
 * 	################### Defining Pauli matrices ###################
 * 	cdef int p, r, c
 * 	for p in range(4):             # <<<<<<<<<<<<<<
 * 		for r in range(2):
 ...
 */
        __pyx_t_4 = __Pyx_c_sum_double(__pyx_t_double_complex_from_parts(0, 0), __Pyx_c_prod_double(__pyx_t_double_complex_from_parts(0, 0), __pyx_t_double_complex_from_parts(0, 1.0)));
        ((((__pyx_v_consts[0]).pauli[__pyx_v_p])[__pyx_v_r])[__pyx_v_c]) = __pyx_t_long_double_complex_from_parts(__Pyx_CREAL(__pyx_t_4), __Pyx_CIMAG(__pyx_t_4));
      }
    }
  }

  /* "src/simulate/constants.pyx":17
 * 				consts[0].pauli[p][r][c] = 0 + 0 * 1j
 * 	# Identity matrix
 * 	consts[0].pauli[0][0][0] = 1 + 1j*0             # <<<<<<<<<<<<<<
 ...
 * 	# Pauli X
 */
  __pyx_t_4 = __Pyx_c_sum_double(__pyx_t_double_complex_from_parts(1, 0), __Pyx_c_prod_double(__pyx_t_double_complex_from_parts(0, 1.0), __pyx_t_double_complex_from_parts(0, 0)));
  ((((__pyx_v_consts[0]).pauli[0])[0])[0]) = __pyx_t_long_double_complex_from_parts(__Pyx_CREAL(__pyx_t_4), __Pyx_CIMAG(__pyx_t_4));

  /* "src/simulate/constants.pyx":18
 * 	# Identity matrix
 * 	consts[0].pauli[0][0][0] = 1 + 1j*0
 * 	consts[0].pauli[0][1][1] = 1 + 1j*0             # <<<<<<<<<<<<<<
 * 	# Pauli X
 ...
 */
  __pyx_t_4 = __Pyx_c_sum_double(__pyx_t_double_complex_from_parts(1, 0), __Pyx_c_prod_double(__pyx_t_double_complex_from_parts(0, 1.0), __pyx_t_double_complex_from_parts(0, 0)));
  ((((__pyx_v_consts[0]).pauli[0])[1])[1]) = __pyx_t_long_double_complex_from_parts(__Pyx_CREAL(__pyx_t_4), __Pyx_CIMAG(__pyx_t_4));

  /* "src/simulate/constants.pyx":20
 * 	consts[0].pauli[0][1][1] = 1 + 1j*0
 * 	# Pauli X
 * 	consts[0].pauli[1][0][1] = 1 + 1j*0             # <<<<<<<<<<<<<<
 ...
 */
  __pyx_t_4 = __Pyx_c_sum_double(__pyx_t_double_complex_from_parts(1, 0), __Pyx_c_prod_double(__pyx_t_double_complex_from_parts(0, 1.0), __pyx_t_double_complex_from_parts(0, 0)));
  ((((__pyx_v_consts[0]).pauli[1])[0])[1]) = __pyx_t_long_double_complex_from_parts(__Pyx_CREAL(__pyx_t_4), __Pyx_CIMAG(__pyx_t_4));

  /* "src/simulate/constants.pyx":21
 * 	# Pauli X
 * 	consts[0].pauli[1][0][1] = 1 + 1j*0
 * 	consts[0].pauli[1][1][0] = 1 + 1j*0             # <<<<<<<<<<<<<<
 * 	# Pauli Y
 ...
 */
  __pyx_t_4 = __Pyx_c_sum_double(__pyx_t_double_complex_from_parts(1, 0), __Pyx_c_prod_double(__pyx_t_double_complex_from_parts(0, 1.0), __pyx_t_double_complex_from_parts(0, 0)));
  ((((__pyx_v_consts[0]).pauli[1])[1])[0]) = __pyx_t_long_double_complex_from_parts(__Pyx_CREAL(__pyx_t_4), __Pyx_CIMAG(__pyx_t_4));

  /* "src/simulate/constants.pyx":23
 * 	consts[0].pauli[1][1][0] = 1 + 1j*0
 * 	# Pauli Y
 * 	consts[0].pauli[2][0][1] = 0 - 1j             # <<<<<<<<<<<<<<
 ...
 * 	# Pauli Z
 */
  __pyx_t_4 = __Pyx_c_diff_double(__pyx_t_double_complex_from_parts(0, 0), __pyx_t_double_complex_from_parts(0, 1.0));
  ((((__pyx_v_consts[0]).pauli[2])[0])[1]) = __pyx_t_long_double_complex_from_parts(__Pyx_CREAL(__pyx_t_4), __Pyx_CIMAG(__pyx_t_4));

  /* "src/simulate/constants.pyx":24
 * 	# Pauli Y
 * 	consts[0].pauli[2][0][1] = 0 - 1j
 * 	consts[0].pauli[2][1][0] = 0 + 1j             # <<<<<<<<<<<<<<
 * 	# Pauli Z
 ...
 */
  __pyx_t_4 = __Pyx_c_sum_double(__pyx_t_double_complex_from_parts(0, 0), __pyx_t_double_complex_from_parts(0, 1.0));
  ((((__pyx_v_consts[0]).pauli[2])[1])[0]) = __pyx_t_long_double_complex_from_parts(__Pyx_CREAL(__pyx_t_4), __Pyx_CIMAG(__pyx_t_4));

  /* "src/simulate/constants.pyx":26
 * 	consts[0].pauli[2][1][0] = 0 + 1j
 * 	# Pauli Z
 * 	consts[0].pauli[3][0][0] = 1 + 1j*0             # <<<<<<<<<<<<<<
 ...
 */
  __pyx_t_4 = __Pyx_c_sum_double(__pyx_t_double_complex_from_parts(1, 0), __Pyx_c_prod_double(__pyx_t_double_complex_from_parts(0, 1.0), __pyx_t_double_complex_from_parts(0, 0)));
  ((((__pyx_v_consts[0]).pauli[3])[0])[0]) = __pyx_t_long_double_complex_from_parts(__Pyx_CREAL(__pyx_t_4), __Pyx_CIMAG(__pyx_t_4));

  /* "src/simulate/constants.pyx":27
 * 	# Pauli Z
 * 	consts[0].pauli[3][0][0] = 1 + 1j*0
 * 	consts[0].pauli[3][1][1] = -1 + 1j*0             # <<<<<<<<<<<<<<
 * 	###############################################################
 ...
 */
  __pyx_t_4 = __Pyx_c_sum_double(__pyx_t_double_complex_from_parts(-1L, 0), __Pyx_c_prod_double(__pyx_t_double_complex_from_parts(0, 1.0), __pyx_t_double_complex_from_parts(0, 0)));
  ((((__pyx_v_consts[0]).pauli[3])[1])[1]) = __pyx_t_long_double_complex_from_parts(__Pyx_CREAL(__pyx_t_4), __Pyx_CIMAG(__pyx_t_4));

  /* "src/simulate/constants.pyx":29
 * 	consts[0].pauli[3][1][1] = -1 + 1j*0
 * 	###############################################################
 * 	consts[0].nclifford = 24             # <<<<<<<<<<<<<<
 ...
 * 	return 0
 */
  (__pyx_v_consts[0]).nclifford = 24;

  /* "src/simulate/constants.pyx":30
 * 	###############################################################
 * 	consts[0].nclifford = 24
 * 	consts[0].atol = 10E-50             # <<<<<<<<<<<<<<
 * 	return 0
 * 
 */
  (__pyx_v_consts[0]).atol = 10E-50;

  /* "src/simulate/constants.pyx":31
 * 	consts[0].nclifford = 24
 * 	consts[0].atol = 10E-50
 * 	return 0             # <<<<<<<<<<<<<<
 * 
...
static int __pyx_f_3src_8simulate_9constants_FreeConstants(CYTHON_UNUSED __pyx_t_3src_8simulate_9constants_constants_t *__pyx_v_consts) {
  int __pyx_r;
  __Pyx_RefNannyDeclarations
  __Pyx_RefNannySetupContext("FreeConstants", 0);

  /* "src/simulate/constants.pyx":36
 * 	# free space allocated to store constants
 * 	# there is currently nothing to free
 * 	return 0             # <<<<<<<<<<<<<<
 * 
...
#endif
{
  ...
  #endif
  if (__pyx_module_is_main_src__simulate__constants) {
    if (PyObject_SetAttrString(__pyx_m, "__name__", __pyx_n_s_main) < 0) __PYX_ERR(0, 1, __pyx_L1_error)
  }
  #if PY_MAJOR_VERSION >= 3
  {
    PyObject *modules = PyImport_GetModuleDict(); if (unlikely(!modules)) __PYX_ERR(0, 1, __pyx_L1_error)
    if (!PyDict_GetItemString(modules, "src.simulate.constants")) {
      if (unlikely(PyDict_SetItemString(modules, "src.simulate.constants", __pyx_m) < 0)) __PYX_ERR(0, 1, __pyx_L1_error)
    }
  }
  #endif
  /*--- Builtin init code ---*/
  ...
  if (__Pyx_ExportFunction("InitConstants", (void (*)(void))__pyx_f_3src_8simulate_9constants_InitConstants, "int (__pyx_t_3src_8simulate_9constants_constants_t *)") < 0) __PYX_ERR(0, 1, __pyx_L1_error)
  if (__Pyx_ExportFunction("FreeConstants", (void (*)(void))__pyx_f_3src_8simulate_9constants_FreeConstants, "int (__pyx_t_3src_8simulate_9constants_constants_t *)") < 0) __PYX_ERR(0, 1, __pyx_L1_error)
  /*--- Type init code ---*/
  /*--- Type import code ---*/
 ...
 */
  ...
  if (__pyx_m) {
    if (__pyx_d) {
      __Pyx_AddTraceback("init src.simulate.constants", __pyx_clineno, __pyx_lineno, __pyx_filename);
    }
    Py_DECREF(__pyx_m); __pyx_m = 0;
  } else if (!PyErr_Occurred()) {
    PyErr_SetString(PyExc_ImportError, "init src.simulate.constants");
  }
  __pyx_L0:;
  __Pyx_RefNannyFinishContext();
  #if PY_MAJOR_VERSION < 3
