...
// Make the functions explained in readme-mt.txt externally available.
...
// Seed the random number generator by an integer.
extern void init_genrand(int seed);
// Seed the random number generator by an array of specified size.
extern void init_by_array(int init_key[], int key_length);
// generates unsigned 32-bit integers.
extern int genrand_int32();
