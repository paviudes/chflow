...
/* BEGIN: Cython Metadata
{
    "distutils": {
        "language": "c", 
        "name": "simulate.constants", 
        "sources": [
            "simulate/constants.pyx"
        ]
    }, 
    "module_name": "simulate.constants"
}
END: Cython Metadata */
...
#define __PYX_HAVE__simulate__constants
#define __PYX_HAVE_API__simulate__constants
/* Early includes */
#ifdef _OPENMP
#include <omp.h>
#endif /* _OPENMP */
...
#define __Pyx_MODULE_NAME "simulate.constants"
extern int __pyx_module_is_main_simulate__constants;
int __pyx_module_is_main_simulate__constants = 0;

/* Implementation of 'simulate.constants' */
...
static int __pyx_f_8simulate_9constants_InitConstants(__pyx_t_8simulate_9constants_constants_t *__pyx_v_consts) {
  int __pyx_v_p;
  int __pyx_v_r;
  int __pyx_v_c;
  int __pyx_r;
...
static int __pyx_f_8simulate_9constants_FreeConstants(CYTHON_UNUSED __pyx_t_8simulate_9constants_constants_t *__pyx_v_consts) {
  int __pyx_r;
  __Pyx_RefNannyDeclarations
  __Pyx_RefNannySetupContext("FreeConstants", 0);

  /* "simulate/constants.pyx":36
 * 	# free space allocated to store constants
 * 	# there is currently nothing to free
 * 	return 0             # <<<<<<<<<<<<<<
 * 
...
static int __Pyx_modinit_function_export_code(void) {
  ...
  if (__Pyx_ExportFunction("InitConstants", (void (*)(void))__pyx_f_8simulate_9constants_InitConstants, "int (__pyx_t_8simulate_9constants_constants_t *)") < 0) __PYX_ERR(0, 1, __pyx_L1_error)
  if (__Pyx_ExportFunction("FreeConstants", (void (*)(void))__pyx_f_8simulate_9constants_FreeConstants, "int (__pyx_t_8simulate_9constants_constants_t *)") < 0) __PYX_ERR(0, 1, __pyx_L1_error)
  __Pyx_RefNannyFinishContext();
  return 0;
  __pyx_L1_error:;
  __Pyx_RefNannyFinishContext();
...
if (!__Pyx_RefNanny) {
  ...
  #endif
  if (__pyx_module_is_main_simulate__constants) {
    if (PyObject_SetAttrString(__pyx_m, "__name__", __pyx_n_s_main) < 0) __PYX_ERR(0, 1, __pyx_L1_error)
  }
  #if PY_MAJOR_VERSION >= 3
  {
    PyObject *modules = PyImport_GetModuleDict(); if (unlikely(!modules)) __PYX_ERR(0, 1, __pyx_L1_error)
    if (!PyDict_GetItemString(modules, "simulate.constants")) {
      if (unlikely(PyDict_SetItemString(modules, "simulate.constants", __pyx_m) < 0)) __PYX_ERR(0, 1, __pyx_L1_error)
    }
  }
  #endif
  /*--- Builtin init code ---*/
 ...
 */
  ...
  if (__pyx_m) {
    if (__pyx_d) {
      __Pyx_AddTraceback("init simulate.constants", 0, __pyx_lineno, __pyx_filename);
    }
    Py_DECREF(__pyx_m); __pyx_m = 0;
  } else if (!PyErr_Occurred()) {
    PyErr_SetString(PyExc_ImportError, "init simulate.constants");
  }
  __pyx_L0:;
  __Pyx_RefNannyFinishContext();
  #if CYTHON_PEP489_MULTI_PHASE_INIT
