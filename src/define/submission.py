...
def Clean(submit, git = 0):
	...
	os.system("find ./../ -maxdepth 3 \( -name \"*.pbs\" -o -name \"*.out\" -o -name \"*.aux\" -o -name \"*.log\" -o -name \"*.fls\" -o -name \"*.bbl\" -o -name \"*.synctex.gz\" -o -name \"*.pyc\" -o -name \"*.c\" -o -name \"*.so\" \) -type f -exec mv \'{}\' ./../ignore/ \\; > /dev/null 2>&1")
	# Remove all latex generated files from docs/
	os.system("find ./../docs \( -name \"*.out\" -o -name \"*.aux\" -o -name \"*.log\" -o -name \"*.fls\" -o -name \"*.bbl\" -o -name \"*.synctex.gz\" \) -type f -exec mv \'{}\' ./../ignore/ \\; > /dev/null 2>&1")
	...
	if (git == 1):
		...
		os.system("mv ./../bqsubmit.dat ./../ignore/ > /dev/null 2>&1")
		os.system("mv ./../log.txt ./../ignore/ > /dev/null 2>&1")
	return None
