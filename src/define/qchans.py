...
Channels = {
    "idn": ["Identity channel", "No parameters.", [""], "white"],
    "ad": ["Amplitude damping channel", "Damping rate", ["$\\lambda$"], "forestgreen"],
    "bf": ["Bit flip channel", "Bit flip probability", ["$p$"], "sienna"],
    "pd": ["Phase damping channel", "Damping rate", ["$p$"], "deeppink"],
    "bpf": [
    ...
    "shd": ["Stochastic Hadamard channel", "Hadamard rate", ["$p$"], "maroon"],
    "sru": ["Stochastic T channel", "T rate", ["$p$"], "chocolate"],
    "rru": ["Rotation about a T axis", "Rotation angle", ["$p$"], "purple"],
    "simcorr": [
