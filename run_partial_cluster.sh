#!/bin/bash
rerun() {
	echo "removing /project/def-jemerson/chbank/$1/channels/*"
	rm /project/def-jemerson/chbank/$1/channels/*
...
if [[ "$1" == "overwrite" ]]; then
	...
	for (( t=1; t<${#timestamps[@]}; ++t )); do
		...
		echo -e "\033[2mremoving /project/def-jemerson/chbank/${ts}/physical/*\033[0m"
		rm /project/def-jemerson/chbank/${ts}/physical/*
